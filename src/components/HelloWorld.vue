<template>
  <v-content>
    ...
    <section id="about-me">
      <v-sheet color="black" dark height="100" tile></v-sheet>
      <v-sheet color="black" dark height="900" tag="section" tile>
      ...
      <v-container class="text-center">
        <v-row>
          <v-col>
            <h2 class="display-2 font-weight-bold mb-3">DEVELOPERS</h2>
